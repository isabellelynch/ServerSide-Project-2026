...
<div id="StudentFormContainer">
    ...
    <form method = 'POST' action = "" id = "AddStudentForm">
        ...
        <label>Email :</label>
            <input type = 'text' name = 'Email' placeholder = 'example@example.com' value = "<?php echo htmlspecialchars($email); ?>">
            <br>

        <label>Phone Number :</label>
            <input type = 'text' name = 'PhoneNo' placeholder = '086-0000000' value = "<?php echo htmlspecialchars($phone); ?>">
            <br>
            <br>
