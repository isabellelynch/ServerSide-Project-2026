...
<div id = "new-admin-form" class = "<?php echo ($admin === true)?'showthisform':'dontshow'; ?>">
    ...
    <label>Surname</label>
        <input type="text" name = "surname" placeholder="eg. Lynch" value = "<?php echo $_SESSION['admin-surname']??''; ?>">

    <label>Email</label>
        <input type="email" name = "email" placeholder="eg. isabelle@gmail.com" value = "<?php echo $_SESSION['admin-email']??''; ?>">
